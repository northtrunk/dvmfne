...
def build_config(_config_file):
    ...
    try:
        for section in config.sections():
            if section == "Global":
                CONFIG["Global"].update({"Path": config.get(section, "Path")})
                ...
                if CONFIG["Reports"]["ReportPort"]:
                    CONFIG["Reports"]["ReportPort"] = int(
                        CONFIG["Reports"]["ReportPort"]
                    )
                if CONFIG["Reports"]["ReportRCM"]:
                    CONFIG["Reports"]["ReportRCM"] = bool(
                        CONFIG["Reports"]["ReportRCM"]
                    )
                ...
                CONFIG["Log"].update(
                    {
                        ...
                        "LogMasterStatus": config.getboolean(
                            section, "LogMasterStatus"
                        ),
                    }
                )
                ...
                CONFIG["Systems"][section]["LOCAL"].update(
                    {
                        ...
                        "PEER_ID": hex(int(config.get(section, "PeerId")))[2:]
                        .rjust(8, "0")
                        .decode("hex"),
                        ...
                        "AuthKey": (
                            config.get(section, "AuthKey").rjust(40, "0")
                        ).decode("hex"),
                ...
                if CONFIG["Systems"][section]["LOCAL"]["XNL_Call"]:
                    FLAG_2 |= 1 << 7
                if (
                    CONFIG["Systems"][section]["LOCAL"]["XNL_Call"]
                    and CONFIG["Systems"][section]["Local"]["XNL_Master"]
                ):
                    FLAG_2 |= 1 << 6
                elif (
                    CONFIG["Systems"][section]["LOCAL"]["XNL_Call"]
                    and not CONFIG["Systems"][section]["Local"]["XNL_Master"]
                ):
                    FLAG_2 |= 1 << 5
                ...
                if CONFIG["Systems"][section]["LOCAL"]["MasterPeer"]:
                    FLAG_2 |= 1 << 0
                CONFIG["Systems"][section]["LOCAL"]["FLAGS"] = (
                    b"\x00\x00" + chr(FLAG_1) + chr(FLAG_2)
                )
